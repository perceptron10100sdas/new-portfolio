...
export default function page() {
  ...
  transition={{duration:1, ease:"anticipate" }} className=' mt-7  h-[490px] w-[290px] sm:w-[340px] ring-1 items-center flex flex-col    hover:shadow-2xl shadow-xl  ring-gray-100 rounded-lg p-7 hover:-translate-y-2  transition-shadow '>
...
<motion.div initial={{ y:200,opacity:0,scale:0
  ...
  <motion.p initial={{ y:100,opacity:0,scale:0}} whileInView={{ y: 0,opacity:1,scale:1}}
  transition={{duration:4, ease:"anticipate" }} className=' text-center mt-2  text-sm text-neutral-700 '>Build trustless, efficient Smart Contracts that automate and revolutionize your business processes</motion.p>
...
<Link href="/blockchain" className=' p-3 text-sm  bg-black text-white font-semibold w-28 text-center shadow-md shadow-black mt-4 rounded-lg'>More info</Link></motion.div> 
  ...
  transition={{duration:4, ease:"anticipate" }} className=' mt-7  h-[490px] w-[290px] sm:w-[340px] ring-1 flex flex-col items-center     ring-gray-100 rounded-lg  p-8  hover:shadow-2xl shadow-xl hover:-translate-y-2   transition-shadow '>
